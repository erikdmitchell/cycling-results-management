    ...
    <div class="rider-rankings">
        ...
        if ( $riders->posts ) :
            ...
            <div class="em-row">
                ...
                <div class="em-col-sm-1 rider-nat"><a href="<?php echo crm_country_url( $rider_rankings_post->nat ); ?>"><?php echo uci_results_get_country_flag( $rider_rankings_post->nat ); ?></a></div>
