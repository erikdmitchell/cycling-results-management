...
<div class="container crm-template crm-single-race">
    ...
    <?php else : ?>
        <h1 class="page-title"><?php echo $post->post_title; ?><span class="flag"><?php echo crm_get_country_flag( $post->nat ); ?></span></h1>
        ...
        <div class="single-race">
            ...
            <?php foreach ( $post->results as $result ) : ?>
                <div class="row rider-results">
                    ...
                    <div class="col-md-1 rider-nat"><?php echo crm_get_country_flag( $result['nat'] ); ?></div>
